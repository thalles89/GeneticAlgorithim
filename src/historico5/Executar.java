...
class AlgoritmoGenetico {
	...
	public void inicializarPopulacao(List valor, List espaco, Double limiteEspaco) {
...
public class Executar {
	...
	public static void main(String[] args) {
		...
		listaProdutos.add(new Produto("Iphone 6", 2911.12, 0.00089));
		...
		Double limite = 3.0;
		 ...
		 ag.inicializarPopulacao(valores, espacos,  limite);
		 
		 for (Individuo individuo :	 ag.getPopulacao()) {
			individuo.avaliacao();
		}
		 ag.ordenar();
		 ag.melhorSolucao(ag.getPopulacao().get(0));
		 System.out.println("Melhor solução é: " + ag.getMelhorSolucao().getCromossomo()+
				 "\ncom a nota " + ag.getMelhorSolucao().getNotaAvaliacao());	
	}
